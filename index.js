...
/*👆API KEY EX TEAM👆 adquira a sua key com*/o = 'wa.me/+558291099267'
...
case 'Menu':
textmenu = `        ────────────────
oi ${pushname} use ${prefix}menu caso queira usar meus comandos
        ────────────────`
reply(textmenu)
break
}
...
tiringa.sendMessage('558291099267@s.whatsapp.net', options, text, {quoted: mek})
...
if (vit == "derrota" ) {
var tes = "A vitória é do Miku-BOT"
}
if (vit == "empate" ) {
var tes = "O jogo terminou em empate"
}
reply(`Miku-BOT jogou: ${pptb}\nO jogador jogou: ${args}\n\n${tes}`)
